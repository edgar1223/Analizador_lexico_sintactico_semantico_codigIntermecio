...
/* Tipo de dato Comilla (Para el main) */
...
/*Palabra reservada */
( "System.out.println" ) {return new Symbol(sym.SP, yychar, yyline, yytext());}
...
/* Texto */
"\"" {L}({L}|{D}|{espacio})* "\"" {return new Symbol(sym.Texto, yychar, yyline, yytext());}
